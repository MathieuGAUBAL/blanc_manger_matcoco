...
class Answer extends Component {
  ...
  handleAward = event => {
    ...
    const test = this.state.randomDescription.map(item =>
      item === player_answser ? this.state.player_answser_ref.indexOf(item) : ""
    );
    ...
    return (
      <div className='container d-flex flex-column justify-content-around answer-group'>
        ...
        <div className='player-card'>
          ...
          >
            <p>{this.state.randomDescription[0]}</p>
          </button>
          {this.state.player1 && (
        ...
        <div className='player-card'>
          <button className='player-button' onClick={this.handleAward}>
            <p>{this.state.randomDescription[1]}</p>
          </button>
          {this.state.player2 && (
            <div className='w3-panel row  mx-auto'>
              <div className='col-12 align-self-center text  mx-auto'>
        ...
        <div className='player-card'>
          <button className='player-button' onClick={this.handleAward}>
            <p>{this.state.randomDescription[2]}</p>
          </button>
          {this.state.player3 && (
            <div className='w3-panel row  mx-auto'>
              <div className='col-12 align-self-center text  mx-auto'>
        ...
        <div className='player-card'>
          <button className='player-button' onClick={this.handleAward}>
            <p>{this.state.randomDescription[3]}</p>
          </button>
          {this.state.player4 && (
            <div className='w3-panel row  mx-auto'>
              <div className='col-12 align-self-center text  mx-auto'>
        ...
        <Link to='/Choice'>
          <button
            className='btn btn-primary next-round'
